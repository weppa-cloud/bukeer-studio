...
allowed-tools: mcp__playwright__browser_navigate, mcp__playwright__browser_click,
  ...
  mcp__playwright__browser_tabs, mcp__playwright__browser_tabs,
  mcp__playwright__browser_tabs, mcp__playwright__browser_snapshot,
  ...
  mcp__playwright__browser_navigate_back, mcp__playwright__browser_press_key,
  mcp__chrome_devtools__list_console_messages, mcp__chrome_devtools__get_console_message,
  mcp__chrome_devtools__list_network_requests, mcp__chrome_devtools__lighthouse_audit,
...
```
If no usable tab → `mcp__playwright__browser_tabs` then navigate to `http://localhost:3000`
...
```
mcp__playwright__browser_take_screenshot { "filename": "qa-screenshots/cycle{N}_{storyId}_{moment}.png" }
```
...
mcp__playwright__browser_type  { "selector": "input[name='title']", "value": "New text" }
...
mcp__chrome_devtools__list_network_requests  // failed requests
```
...
After each error test → `mcp__playwright__browser_run_code` to reset routes.
