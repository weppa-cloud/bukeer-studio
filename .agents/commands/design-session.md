...
Run via `mcp__chrome_devtools__lighthouse_audit`:
- Performance score
- Accessibility score
...
| `mcp__chrome_devtools__list_console_messages` | 4 | Debug rendering issues |
| `mcp__chrome_devtools__lighthouse_audit` | 5 | Performance audit |
