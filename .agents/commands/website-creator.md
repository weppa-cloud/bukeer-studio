...
allowed-tools: mcp__supabase__execute_sql,
  ...
  mcp__chrome_devtools__list_console_messages, mcp__chrome_devtools__lighthouse_audit,
...
| `mcp__chrome_devtools__list_console_messages` | Debug rendering issues after changes |
| `mcp__chrome_devtools__lighthouse_audit` | Performance audit |
...
6. IF BROKEN:
   a. Check console for errors (mcp__chrome_devtools__list_console_messages)
