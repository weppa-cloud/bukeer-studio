/**
 * Mirror of `lib/growth/autonomy/gate.test.ts` so jest (roots = __tests__/)
 * picks up the Lane-Level Autonomy Gate unit tests. See note at the top of
 * the canonical file. Keep the two files in sync.
 */
import { evaluateGate, type GateInput } from '@/lib/growth/autonomy/gate';
import type { LaneAgreement } from '@/lib/growth/autonomy/lane-agreement';
