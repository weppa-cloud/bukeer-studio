...
const CHANNEL_BADGE: Record<
  ConversationChannel,
  { className: string; icon: EvoIconName }
> = {
...
export function EvoConversations({
  ...
  const hasConversations = fixture.conversations.length > 0;
    ...
    <>
      <div className="page-head">
        ...
        <div className="actions">
          ...
          <span
            ...
            data-testid="admin-next-conversations-new"
          >
      ...
      {hasConversations ? (
        <div className="conv" data-testid="admin-next-conversations-layout">
            ...
            <div className="conv-tools">
              ...
              <div className="filterbar">
                <span className="fchip on">
                  Mías · {fixture.conversations.length}
                </span>
          ...
          <div className="thread" data-testid="admin-next-conversations-thread">
            <div className="thread-head">
              ...
              <div className="actions">
                ...
                >
                  {fixture.selected.realtime.mirrorLabel}
                </span>
                <span
                  className="btn outline"
                  style={{ fontSize: "var(--fs-xs)", padding: "5px 11px" }}
                >
            ...
            <div className="msgs">
              ...
              {selected.messages.map((message) =>
                message.author === "assistant" ? (
                  ...
                  <div
                    key={message.id}
                    className={`msg ${message.author === "customer" ? "in" : "out"}`}
                  >
                    {message.body}
          ...
          >
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <span
                  style={{ fontSize: "var(--fs-xs)", color: "var(--text3)" }}
                >
            ...
            <div className="panel-sec">
              ...
              >
                ...
                <div className="sub">
                  {fixture.selected.linkedItinerary.id} ·{" "}
                  {fixture.selected.linkedItinerary.state}
                </div>
                ...
                >
                  ...
                  <b style={{ color: "var(--text2)", fontWeight: 500 }}>
                    {selected.valueLabel}
                  </b>
                </div>
              </Link>
        ...
        <EvoDataState
          kind="empty"
          title="Sin conversaciones visibles"
          description="No hay conversaciones abiertas, en espera o sin asignar para este usuario."
          actionHref="/admin/conversations"
          actionLabel="Limpiar filtros"
          testId="admin-next-conversations-empty"
        />
      )}
    </>
  );
