    ...
    <>
      <div className="page-head">
        ...
        <div className="actions">
          <span
            ...
            data-testid="admin-next-products-filters"
          >
      ...
      <div className="ptabs" data-testid="admin-next-products-tabs">
        {tabs.map((category, index) => (
          ...
          >
            <EvoIcon name={CATEGORY_ICONS[category.key] ?? "box"} size={15} />{" "}
      ...
      <div className="prod-grid" data-testid="admin-next-products-grid">
        {fixture.products.length > 0 ? (
          fixture.products.map((product) => (
            <Link
              key={product.id}
              className="card prod-card"
              data-testid={`admin-next-product-${product.id}`}
          ...
          <EvoDataState
            ...
            description="No hay hoteles, actividades, vuelos o traslados para los filtros actuales."
            actionHref="/admin/products"
            actionLabel="Limpiar filtros"
            testId="admin-next-products-empty"
          />
        )}
      </div>
    </>
