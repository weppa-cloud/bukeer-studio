    ...
    <section data-testid="detail-gallery">
      ...
      <div className="grid gap-3 lg:grid-cols-3">
        <button
          ...
          className="group relative aspect-video w-full cursor-zoom-in overflow-hidden rounded-xl lg:col-span-2 lg:aspect-auto lg:min-h-[420px]"
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-2 lg:auto-rows-[1fr]">
          {images.slice(0, 4).map((image, index) => (
            <button
              ...
              className={`relative aspect-[4/3] cursor-zoom-in overflow-hidden rounded-xl border-2 transition-colors lg:aspect-square ${
