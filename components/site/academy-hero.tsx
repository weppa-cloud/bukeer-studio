    ...
    <section className="relative w-full py-20 lg:py-32 overflow-hidden bg-slate-950">
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tighter text-white sm:text-5xl md:text-6xl lg:text-7xl">
          Rompe tu <span className="text-emerald-500">Excel</span>
        </h1>
        
        <p className="max-w-[700px] mx-auto mt-4 text-slate-400 md:text-xl">
          Deja de operar a ciegas. Aprende a sistematizar tu agencia de viajes y recupera tu libertad en 4 módulos prácticos.
        </p>
        ...
        <div className="mt-12 p-4 bg-slate-900/50 rounded-lg border border-slate-800 inline-block">
          <p className="text-sm text-slate-400">
            <span className="text-emerald-400 font-bold">🎁 Bonus:</span> Incluye Plantilla Maestra de Cotización + Calculadora de Costos
          </p>
        </div>
      </div>
    </section>
