        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="mt-8 space-y-6">
              {(content.account?.email || content.contact?.email) && (
                <a href={`mailto:${content.account?.email || content.contact?.email}`} className="flex items-center gap-4 group">
              ...
              {(content.account?.phone || content.contact?.phone) && (
                <a href={`tel:${content.account?.phone || content.contact?.phone}`} className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
