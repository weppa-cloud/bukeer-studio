...
const styles: Record<string, React.CSSProperties> = {
  ...
  toggleBtn: {
    ...
    border: '1px solid color-mix(in srgb, var(--studio-primary) 24%, transparent)',
    borderRadius: 8,
    cursor: 'pointer',
    fontSize: 13,
    fontWeight: 500,
    ...
    width: '100%',
    fontFamily: "var(--font-studio-ui), var(--font-sans), sans-serif",
  },
  header: {
    display: 'flex',
  ...
  error: {
    ...
    justifyContent: 'space-between',
    alignItems: 'center',
    border: '1px solid color-mix(in srgb, var(--studio-danger) 24%, transparent)',
  },
  retryBtn: {
    fontSize: 11,
    color: 'var(--studio-primary)',
