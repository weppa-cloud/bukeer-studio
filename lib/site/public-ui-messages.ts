...
const FR_FR_MESSAGES: PublicUiMessages = {
  ...EN_US_MESSAGES,
  nav: {
    ...EN_US_MESSAGES.nav,
    home: 'Accueil',
    ...
    about: 'À propos',
    advisory: 'Conseil voyage',
    hotels: 'Hôtels',
    blog: 'Blog',
  },
  header: {
    ...EN_US_MESSAGES.header,
    menuAria: 'Menu',
    ...
    customizeExperience: 'Personnaliser votre expérience',
    language: 'Langue',
    currency: 'Devise',
    whatsappAria: 'Ouvrir WhatsApp',
  },
  footer: {
    ...EN_US_MESSAGES.footer,
    planTripTitle: 'Planifions votre voyage en Colombie',
    planTripSubtitle: 'Itinéraires, hôtels et activités en une seule session de conseil.',
    talkWhatsapp: 'Parler via WhatsApp',
  ...
  mobileStickyBar: { call: 'Appeler', whatsapp: 'WhatsApp', email: 'E-mail' },
  contactForm: {
    ...EN_US_MESSAGES.contactForm,
  ...
  bookingWidget: {
    ...EN_US_MESSAGES.bookingWidget,
    reserveExperience: 'Réserver cette expérience',
    priceConsultPerPerson: 'Demandez le prix par personne',
    dateLabel: 'Date',
    peopleLabel: 'Personnes',
    reserveByWhatsapp: 'Réserver via WhatsApp',
  },
  stickyCta: { ...EN_US_MESSAGES.stickyCta, whatsapp: 'WhatsApp', call: 'Appeler' },
  productDetail: {
    ...EN_US_MESSAGES.productDetail,
...
const DE_DE_MESSAGES: PublicUiMessages = {
  ...EN_US_MESSAGES,
  nav: {
    ...EN_US_MESSAGES.nav,
    home: 'Startseite',
  ...
  header: {
    ...
    customizeExperience: 'Erlebnis personalisieren',
    language: 'Sprache',
    currency: 'Währung',
  ...
  footer: {
    ...EN_US_MESSAGES.footer,
    planTripTitle: 'Planen wir Ihre Reise durch Kolumbien',
    planTripSubtitle: 'Reiserouten, Hotels und Aktivitäten in einer Beratung.',
    talkWhatsapp: 'Per WhatsApp sprechen',
  ...
  mobileStickyBar: { call: 'Anrufen', whatsapp: 'WhatsApp', email: 'E-Mail' },
  contactForm: {
    ...EN_US_MESSAGES.contactForm,
    titleDefault: 'Kontaktieren Sie uns',
    subtitleDefault: 'Wir helfen Ihnen bei der Planung Ihrer nächsten Reise',
    phoneLabel: 'Telefon',
    addressLabel: 'Adresse',
    nameLabel: 'Name',
  ...
  searchPage: {
    ...
    noResultsHint: 'Versuchen Sie andere Begriffe oder erkunden Sie unsere Kategorien',
  ...
  bookingWidget: {
    ...EN_US_MESSAGES.bookingWidget,
    reserveExperience: 'Dieses Erlebnis buchen',
    priceConsultPerPerson: 'Preis pro Person anfragen',
    dateLabel: 'Datum',
    peopleLabel: 'Personen',
    reserveByWhatsapp: 'Per WhatsApp buchen',
  },
  stickyCta: { ...EN_US_MESSAGES.stickyCta, whatsapp: 'WhatsApp', call: 'Anrufen' },
  productDetail: {
    ...EN_US_MESSAGES.productDetail,
    galleryTitle: 'Galerie',
    fromLabel: 'Ab',
