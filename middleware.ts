...
export const config = {
  ...
  matcher: [
     ...
     * - public folder files
     */
    "/((?!api|admin/prototype|admin/dashboard|admin/contacts|admin/conversations|admin/products|admin/reports|admin/payments|admin/agenda|admin/account|admin/settings|_next/static|_next/image|favicon.ico|.*\\.avif$|.*\\.gif$|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$|.*\\.webp$).*)",
  ],
};
