...
export const config = {
  ...
  matcher: [
     ...
     * - api (API routes)
     * - admin/prototype and admin/dashboard (Admin Next routes guard themselves server-side)
     ...
     * - public folder files
     */
    "/((?!api|admin/prototype|admin/dashboard|login|forgot-password|reset-password|_next/static|_next/image|favicon.ico|.*\\.avif$|.*\\.gif$|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$|.*\\.webp$).*)",
  ],
};
