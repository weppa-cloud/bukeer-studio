...
export const config = {
  ...
  matcher: [
     ...
     * - public folder files
     */
    "/((?!api|admin/prototype|admin/dashboard|admin/contacts|admin/agenda|admin/account|login|forgot-password|reset-password|_next/static|_next/image|favicon.ico|.*\\.avif$|.*\\.gif$|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$|.*\\.webp$).*)",
  ],
};
