...
optional_vars=(
  ...
  E2E_WEBSITE_ID
  GITHUB_TOKEN
  GITHUB_DEPLOY_WAIT_SECONDS
  GITHUB_DEPLOY_POLL_SECONDS
)
...
export CI_QUALITY_PROVIDER="${CI_QUALITY_PROVIDER:-github}"
export CI_DEPLOY_PROVIDER="${CI_DEPLOY_PROVIDER:-github}"
