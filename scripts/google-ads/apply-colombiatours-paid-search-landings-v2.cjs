...
const landings = [
  ...
  marketLanding({
    ...
    subtitle: 'Paquetes a Colombia desde Chile y paquete de viajes a Colombia desde Santiago hacia Cartagena, Medellin, San Andres y Eje Cafetero, con hoteles, traslados, experiencias y soporte por WhatsApp.',
    intro: 'Esta landing protege calidad en Chile enfocando la pauta en Santiago y en viajeros que buscan paquetes a Colombia, paquete de viajes a Colombia, paquete turistico a Colombia y Colombia paquetes de viaje, no cotizaciones sueltas.',
    ...
    cityProofBody: 'Cuando el lead viene de Santiago podemos estimar entrada, dias utiles, vuelos internos y ruta sin abrir todo el pais. Esta promesa debe conectar con anuncios de paquetes a Colombia desde Chile y viajes a Colombia desde Santiago.',
  ...
  marketLanding({
    ...
    subtitle: 'Paquetes a Colombia desde Argentina y paquete de viajes a Colombia desde Buenos Aires hacia Cartagena, Medellin, Eje Cafetero y San Andres, con planner local, hoteles y experiencias coordinadas.',
    intro: 'Esta pagina queda lista para la fase AR despues del gate de Brasil, enfocada en Buenos Aires y en leads con intencion comercial real: paquetes a Colombia, paquete de viajes a Colombia, paquete turistico a Colombia y Colombia paquetes de viaje.',
    origin: 'Buenos Aires',
    originProof: 'Buenos Aires',
    cityProofHeadline: 'Buenos Aires debe activarse solo despues del gate BR y con exact-first.',
    cityProofBody: 'La landing esta preparada para capturar ciudad de salida, fechas, viajeros y presupuesto antes de pasar a ventas, con copy alineado a viajes a Colombia desde Argentina y paquetes a Colombia desde Buenos Aires.',
  ...
  destinationLanding({
    ...
    subtitle: 'Un itinerario privado para tour Bogota Colombia, Medellin Colombia y tour Medellin y Cartagena, combinando capital, cultura urbana y Caribe con hoteles, traslados, experiencias y soporte local.',
    intro: 'Bogota, Medellin y Cartagena es la ruta base mas clara para convertir intencion general de Colombia, tour Bogota Colombia y tour Medellin y Cartagena en una propuesta concreta.',
    promiseHeadline: 'La promesa del anuncio debe aterrizar en una ruta multi-ciudad real, no en un producto inexistente.',
    promiseBody: 'Este paquete responde a busquedas de Colombia completo, Medellin Colombia, tour Medellin y Cartagena, tour Bogota Colombia, Bogota y Caribe.',
  ...
  destinationLanding({
    ...
    subtitle: 'Tour Medellin y Cartagena con Cartagena de Indias, Islas del Rosario, Medellin Colombia y Guatape en una ruta clara, cotizable y no hotel-only.',
    intro: 'Cartagena + Medellin es una combinacion de alta intencion para viajeros que buscan tour Medellin y Cartagena, Medellin Colombia o paquetes a Colombia sin hacer una ruta demasiado larga.',
    promiseHeadline: 'Cartagena y Medellin deben venderse como ruta coordinada, no como dos tours sueltos.',
    promiseBody: 'La landing conecta ciudad, playa, cultura y logistica para busquedas de tour Medellin y Cartagena, Medellin Colombia y Cartagena de Indias, evitando leads que solo preguntan por hotel.',
