...
const requiredRoutes = [
  [
    ...
    "app/admin/dashboard/smoke/page.tsx",
  ],
  [
    "Contactos",
    "app/admin/contacts/page.tsx",
    "app/admin/contacts/smoke/page.tsx",
  ],
  ["Agenda", "app/admin/agenda/page.tsx", "app/admin/agenda/smoke/page.tsx"],
  [
    "Mi cuenta",
    "app/admin/account/page.tsx",
    "app/admin/account/smoke/page.tsx",
  ],
  [
    "Configuracion",
    "app/admin/settings/page.tsx",
    "app/admin/settings/smoke/page.tsx",
  ],
  [
    "Productos",
    "app/admin/products/page.tsx",
    "app/admin/products/smoke/page.tsx",
  ],
  [
    "Conversaciones",
    "app/admin/conversations/page.tsx",
    "app/admin/conversations/smoke/page.tsx",
  ],
  [
    "Reportes",
    "app/admin/reports/page.tsx",
    "app/admin/reports/smoke/page.tsx",
  ],
  ["Pagos", "app/admin/payments/page.tsx", "app/admin/payments/smoke/page.tsx"],
  [
    "Package Kits",
    "app/admin/package-kits/page.tsx",
    "app/admin/package-kits/smoke/page.tsx",
  ],
  [
    "Itinerarios",
    "app/admin/itineraries/page.tsx",
    "app/admin/itineraries/smoke/page.tsx",
  ],
];
...
function checkPhaseIssue() {
  ...
  if (!output) {
    ...
    if (manualStatus === "pass") {
      addCheck(`github issue ${phaseIssueNumber}`, "pass", {
        ...
        reason:
          "manual phase issue verification supplied because gh was unavailable",
      });
      return;
    }
  ...
  addCheck(
    ...
    issue.state === "OPEN" && fiveSlicesDone && cutoverOpen ? "pass" : "fail",
    {
      ...
      checklistLine,
      expected:
        "first five slices checked, Corte final unchecked before cutover",
    },
  );
}
...
function checkFlutterCutoverContract() {
  ...
  if (!output) {
    ...
    if (manualStatus === "pass") {
      addCheck("flutter cutover contract", "pass", {
        ...
        reason:
          "manual Flutter contract verification supplied because gh was unavailable",
      });
      return;
    }
  ...
  addCheck(
    ...
    contractPresent && prStateOk ? "pass" : "fail",
    {
      ...
      note: "This proves the Flutter policy surface exists; final cutover still requires actual freeze/read-only flags and PR checks/merge evidence.",
    },
  );
}
