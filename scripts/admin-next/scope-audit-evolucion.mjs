...
const PHASE0_ALLOWLIST = [
  ...
  /^lib\/admin-next\/fixtures\/conversations\.ts$/,
  /^lib\/admin-next\/fixtures\/itineraries\.ts$/,
  /^lib\/admin-next\/fixtures\/products\.ts$/,
  /^lib\/admin-next\/fixtures\/reports\.ts$/,
  /^lib\/admin-next\/fixtures\/payments\.ts$/,
  /^lib\/admin-next\/fixtures\/dashboard\.ts$/,
  /^lib\/admin-next\/fixtures\/settings\.ts$/,
  /^lib\/auth\/safe-redirect\.ts$/,
  /^middleware\.ts$/,
  /^package\.json$/,
  /^packages\/admin-contract\/src\/index\.ts$/,
  /^wrangler\.toml$/,
  /^scripts\/admin-next\//,
  ...
  /^__tests__\/app\/admin-next-conversations-page\.test\.tsx$/,
  /^__tests__\/app\/admin-next-itineraries-page\.test\.tsx$/,
  /^__tests__\/app\/admin-next-products-page\.test\.tsx$/,
  /^__tests__\/app\/admin-next-reports-page\.test\.tsx$/,
  ...
  /^__tests__\/components\/admin-next\/conversations-module\.test\.tsx$/,
  /^__tests__\/components\/admin-next\/itineraries-module\.test\.tsx$/,
  /^__tests__\/components\/admin-next\/products-module\.test\.tsx$/,
  /^__tests__\/components\/admin-next\/reports-module\.test\.tsx$/,
  /^__tests__\/components\/admin-next\/payments-module\.test\.tsx$/,
