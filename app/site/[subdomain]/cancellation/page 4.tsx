...
export async function generateMetadata({ params }: CancellationPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Politica de cancelacion de ${siteName}`,
      ...
      <div className="container max-w-4xl">
        ...
        <nav className="mb-8">
          <ol className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <li>/</li>
            <li className="text-foreground">Politica de Cancelacion</li>
          </ol>
        </nav>

        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold">Politica de Cancelacion</h1>
