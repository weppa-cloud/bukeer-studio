...
Latest learning-run: 2026-05-15 - [[colombiatours-public-routing-recovery-w1]] records the ColombiaTours public routing recovery Week 1 certification: 7-task pipeline (specifier → plan gate → live audit → dev → code gate → QA gate → ops → learning-curator), PR #551 open (awaiting Yeison review), system fallback pages for contacto/prensa, and 6 proposed follow-up candidates (pipeline architecture for site recovery, fallback locale-awareness, i18n translations, pt locale mapping fix, PR-target CI, buscar title fix).
...
Latest spec addition: 2026-05-14 - [[github-542-learning-loop-20260514-SPEC]] defines the executable implementation plan for GitHub #542: add T6 learning-curator to the development Kanban pipeline, document memory boundaries, learning-run templates/schema, task metadata contracts, and Villa de Leyva backfill handling.

Latest learning-run: 2026-05-14 - [[dev-pipeline-learning-loop-542-learning-run]] records the T6 learning-curator output for the GitHub #542 pipeline: all 6 gates (T0→T5) passed, PR #543 opened, learning-candidates curated and routed to skill/pattern/follow-up targets.

Latest spec addition: 2026-05-14 - [[villa-leyva-dev-20260514b-SPEC]] defines the executable fix plan for the ColombiaTours Villa de Leyva destination bug: canonical `villa-de-leyva`, Leiva typo alias handling, destination listing/detail/search/featured/SEO validation, and minimal data-first remediation for website `894545b7-73ca-4dae-b76a-da5b6a3f8441`.

Prior learning-run: 2026-05-14 - [[provider-runner-beta-538-20260514]] records the #538 Provider Runner Beta certification: 7-task pipeline (specifier → tech-validator plan → developer → tech-validator code → QA → ops → learning-curator), PR #548 update branch, gate-first runner architecture validated across 6 gates, GSC read-only first path, and 3 proposed follow-up candidates for #539/#540.

Latest spec addition: 2026-05-13 - [[SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0]] defines Epic #521 for the ColombiaTours Hermes primary runtime MVE v0 steel thread: native Hermes Kanban as runtime queue, board-per-website scope, profile skill bindings, `/goal` + `delegate_task`, tenant/provider context hydration, North Star task scoring, scoped MCP Tool Safety Layer for autonomous production actions, and Supabase reduced to product/audit/snapshot/outcome storage. Delivery child issues: #522-#533.
...
Latest spec addition: 2026-05-11 - [[SPEC_GROWTH_OS_HERMES_CHIEF_OF_STAFF_SWARM]] defines Epic #482: Hermes-powered Growth Chief of Staff, conversation/action ledger, editable agent instances, agent artifacts and a hybrid swarm layer that keeps Growth OS as the live-gated mutation boundary.

Latest spec addition: 2026-05-11 - [[SPEC_GROWTH_OS_HERMES_AGENT_CONTEXT_ISOLATION_9]] defines the next 9/10 layer after #482: strict per-agent skills, memories, toolsets, context manifests, sidecar enforcement and learning-impact certification.

Latest certification evidence: 2026-05-11 - [[growth-effectiveness-human-baseline-2026-05-11]] adds the benchmark layer for testing Growth OS + Hermes against a human/Codex baseline: experiment/observation ledger, executor-only mutation boundary, scorecard UI and production batch readiness.

Latest spec addition: 2026-05-10 - [[SPEC_GROWTH_OS_PROVIDER_EXTRACTION_PROFILES]] defines the provider extraction layer for Growth OS: DataForSEO, GA4, GSC and Microsoft Clarity become versioned, freshness-governed profiles with cited evidence for Brain decisions and live-gated execution.

Latest tracking note: 2026-05-11 - [[SPEC_FUNNEL_EVENTS_OBSERVABILITY_LAYER]] adds F6 under #419: GA4 Measurement Protocol and Microsoft Clarity become diagnostic/observability layers around `funnel_events`, while Supabase remains the conversion SOT for agents and paid optimization.
...
Latest operational evidence: 2026-05-12 - [[growth-os-ready-cleanup-2026-05-12]] records the strict Growth OS `ready` queue cleanup and runtime `pre_ready_reconciliation` fix: invalid ready work blocked, duplicate ready groups cleared, production validation cycle `0566b92b-1fc9-4596-939b-c843c8acbf6d`, and remaining Clarity rate-limit watch.
...
| [[dev-pipeline-learning-loop-542-learning-run]]            | [file](./ai/learning-runs/2026-05-14-dev-pipeline-learning-loop-542.md)    | [[learning-loop]] [[learning-curator]] [[Kanban]] [[Hermes]] [[dev-pipeline]] [[GitHub-542]]                                                                     |
...
| [[SPEC_COLOMBIATOURS_LOCALE_TRUST_RECOVERY]]              | [file](./specs/generated/colombiatours-locale-trust-recovery-SPEC.md)    | [[ColombiaTours]] [[multi-locale]] [[trust]] [[commercial-ux]] [[contact]] [[hotels]] Week 2 locale/trust/commercial UX recovery spec |
...
| [[SPEC_GROWTH_OS_CONTROL_PLANE_UX]]                       | [file](./specs/SPEC_GROWTH_OS_CONTROL_PLANE_UX.md)                       | [[growth-os]] [[agents]] [[Bukeer Studio]] [[UX]] [[Council]]                                                                                                   |
| [[SPEC_GROWTH_OS_AGENT_MODEL_AND_WORKFLOW_REGISTRY]]      | [file](./specs/SPEC_GROWTH_OS_AGENT_MODEL_AND_WORKFLOW_REGISTRY.md)      | [[growth-os]] [[agents]] [[OpenAI]] [[workflow]] [[VPS]]                                                                                                        |
| [[SPEC_GROWTH_OS_RUNTIME_8_5_HERMES_INSPIRED]]            | [file](./specs/SPEC_GROWTH_OS_RUNTIME_8_5_HERMES_INSPIRED.md)            | [[growth-os]] [[agents]] [[Codex]] [[Hermes]] [[learning-loop]]                                                                                                 |
| [[SPEC_GROWTH_OS_AGENT_CHANGE_SETS_WORK_CENTER]]          | [file](./specs/SPEC_GROWTH_OS_AGENT_CHANGE_SETS_WORK_CENTER.md)          | [[growth-os]] [[agents]] [[change-sets]] [[Bukeer Studio]] [[UX]] [[E2E]] [[human-governed-publishing]]                                                         |
| [[SPEC_GROWTH_OS_WORKBOARD_UX_AUDIT_9_5]]                 | [file](./specs/SPEC_GROWTH_OS_WORKBOARD_UX_AUDIT_9_5.md)                 | [[growth-os]] [[UX]] [[Workboard]] [[Linear]] [[E2E]] [[ColombiaTours]]                                                                                         |
...
| [[PLAN_GROWTH_OS_PROVIDER_RUNNER_BETA_ISSUE_538]]        | [file](./plans/PLAN_GROWTH_OS_PROVIDER_RUNNER_BETA_ISSUE_538.md)          | [[growth-os]] [[provider-profiles]] [[provider-runner]] [[GSC]] [[GA4]] [[freshness-gate]] [[approval-gate]] [[budget-gate]] [[circuit-breaker]] [[run-ledger]] [[Supabase]] |
...
| [[SPEC_FUNNEL_EVENTS_OBSERVABILITY_LAYER]]                 | [file](./specs/SPEC_FUNNEL_EVENTS_OBSERVABILITY_LAYER.md)                 | [[funnel-events]] [[observability]] [[GA4]] [[clarity]] [[growth-os]] [[agents]] [[ColombiaTours]] — F6 diagnostic layer for [[SPEC_FUNNEL_EVENTS_SOT]]          |
| [[SPEC_FUNNEL_EVENTS_GOAL_PROVISIONING_SYNC]]              | [file](./specs/SPEC_FUNNEL_EVENTS_GOAL_PROVISIONING_SYNC.md)              | [[funnel-events]] [[goal-sync]] [[Google Ads]] [[GA4]] [[Meta CAPI]] [[clarity]] [[multi-tenant]] [[growth-os]] — F7 platform goal provisioning for [[SPEC_FUNNEL_EVENTS_SOT]] |
...
| [[transcreation-inventory-ralph]]       | [file](./seo/transcreation-inventory-ralph.md)       | Epic #502 inventory matrix: 2,511 items, locale distribution, gap analysis, P0/P1/P2 priorities.                                                        |
| [[global-transcreation-plan]]           | [file](./plans/global-transcreation-plan.md)          | Epic #502 plan operativo: 8 fases (F0-F7) con dependencias, tareas, riesgos, y verificación post-publish obligatoria.                                  |
| [[ralph-implementation-plan]]           | [file](./plans/ralph-implementation-plan.md)          | Iteración Ralph: plan de implementación con 3 sprints, archivos a modificar, checklist por fase.                                                       |
...
| [[supabase-migration-governance]]        | [file](./ops/supabase-migration-governance.md)        | Cross-repo migration governance and production reconciliation protocol: Studio may originate shared DB migrations, Flutter is the operational SSOT for applying them.                          |
| [[supabase-migration-reconciliation-2026-05-08]] | [file](./ops/supabase-migration-reconciliation-2026-05-08.md) | Production migration reconciliation report: linked Flutter remote history, duplicate cleanup, candidate repair/apply bundle and Studio-only block. |
...
| [[AUDIT_GROWTH_OS_PROVIDER_PROFILE_REGISTRY_MAP_2026-05]] | [file](./audits/AUDIT_GROWTH_OS_PROVIDER_PROFILE_REGISTRY_MAP_2026-05.md) | Issue #536 provider registry audit map: 45 DataForSEO/GSC/GA4/tracking/joint profiles plus Clarity and paid-media PASS/WATCH/BLOCKED matrix, produced without provider API calls. |
...
| [[epic471-provider-intelligence-certification-2026-05-10]] | [file](./growth-sessions/2026-05-10-epic471-provider-intelligence-certification.md) | Epic #471 Provider Intelligence certification: DataForSEO/GSC/GA4 live profile evidence, Clarity live PASS, provider-backed candidates/work items, anti-rework and Growth OS UI E2E 16/16. |
| [[issue451-production-qa-certification-2026-05-11]] | [file](./growth-sessions/2026-05-11-issue451-production-qa-certification.md) | Issue #451 closure certificate: ColombiaTours production cycles, content/transcreation/safe_apply smoke-passed jobs, paid mutation block, duplicate-post cleanup and session-pool E2E. |
| [[epic471-backlog-cleanup-2026-05-11]] | [file](./growth-sessions/2026-05-11-epic471-backlog-cleanup.md) | Epic #471 operational cleanup: production backlog duplicate/noise normalization with confirm-token apply evidence and post-cleanup queue validation. |
| [[epic471-backlog-cleanup-followup-2026-05-11]] | [file](./growth-sessions/2026-05-11-epic471-backlog-cleanup-followup.md) | Epic #471 post-deploy follow-up: stale cycle reconciliation, duplicate ready work blocking, controlled live-gated transcreation/technical batches, pre-ready contract gate hardening and final queue validation. |
| [[growth-effectiveness-human-baseline-2026-05-11]] | [file](./growth-sessions/2026-05-11-growth-effectiveness-human-baseline.md) | Growth OS + Hermes effectiveness benchmark: human/Codex baseline, deterministic runtime and Hermes isolated agents measured through the same executor-only mutation boundary. |
| [[growth-os-ready-cleanup-2026-05-12]] | [file](./growth-sessions/2026-05-12-growth-os-ready-cleanup.md) | Strict `ready` queue cleanup and runtime pre-ready reconciliation: production invalid ready work blocked, duplicate groups cleared, validation cycle `0566b92b-1fc9-4596-939b-c843c8acbf6d`, and Clarity rate-limit watch. |
...
| [[colombiatours-keyword-market-research-2026-05-11]] | [file](./growth-campaigns/outputs/2026-05-11-colombiatours-keyword-market-research.md) | ColombiaTours paid-search market/product matrix: DataForSEO + Google Ads evidence, qualified-lead scoring, experiment gates and landing gaps. |
| [[colombiatours-global-keyword-market-research-v2-2026-05-11]] | [file](./growth-campaigns/outputs/2026-05-11-colombiatours-global-keyword-market-research-v2.md) | Global ColombiaTours paid-search expansion matrix across LATAM, North America, Europe, Brazil and English-speaking markets; landing prerequisites and test gates. |
| [[colombiatours-global-landings-2026-05-11]] | [file](./growth-sessions/2026-05-11-1715-colombiatours-global-landings.md) | Production execution log for Brazil, France, Germany and Argentina paid-search landing pages plus Google Ads exact/phrase test package. |
| [[colombiatours-global-transcreation-plan-2026-05-11]] | [file](./growth-campaigns/outputs/2026-05-11-colombiatours-global-transcreation-plan.md) | Global DE/FR/PT-BR transcreation plan for ColombiaTours pages, products, packages, hreflang, sitemap, publish gates and batch rollout. |
...
- [[supabase-migration-reconciliation-2026-05-08]] → `docs/ops/supabase-migration-reconciliation-2026-05-08.md`
...
- [[SPEC_COLOMBIATOURS_LOCALE_TRUST_RECOVERY]] — Week 2 locale/trust/commercial UX recovery contract for PT/FR/DE UI safety, `/buscar`, `/hoteles`, contact/press fallback locale-awareness and CTA consistency
...
- [[SPEC_GROWTH_OS_RUNTIME_8_5_HERMES_INSPIRED]] — Runtime maturity score target for #310: raise Bukeer Growth OS Runtime from ~7.0/10 to 8.5/10, then 9/10, using Hermes-inspired execution, active memory/skills in prompts, tool gateway, replay/evals, observability, Workboard ops controls and Studio learning surfaces.
- [[SPEC_GROWTH_OS_AGENT_CHANGE_SETS_WORK_CENTER]] — Apply Layer for #310: every run produces a reviewable change set; few high-output lane agents own many capabilities; Bukeer Studio becomes a marketing Work Center with full E2E coverage for previews, approvals, role gates and safety gates.
- [[SPEC_GROWTH_OS_WORKBOARD_UX_AUDIT_9_5]] — UX audit baseline for #310 Workboard: audited Growth OS flows, baseline 7.1/10, Linear-inspired gaps and plan to reach >9.5/10 for ColombiaTours marketing operators.
- [[SPEC_GROWTH_OS_PAPERCLIP_AUTONOMOUS_CEO_COCKPIT]] — Paperclip-style CEO cockpit and aggressive organic + technical autonomy for ColombiaTours: `growth_work_items` as primary queue, publication jobs, outcomes, caps, rollback gates and no paid auto-mutation.
...
- [[SPEC_GROWTH_OS_HERMES_CHIEF_OF_STAFF_SWARM]] — Epic #482 architecture for the hybrid Hermes/Growth OS layer: Growth Chief of Staff chat, action router, editable agent instances, Hermes lane artifacts, multi-tenant tool scoping and executor-only live-gated mutation.
- [[SPEC_GROWTH_OS_HERMES_AGENT_CONTEXT_ISOLATION_9]] — next 9/10 layer after #482: strict per-agent skills/memories/toolsets, context manifests, sidecar enforcement and learning-impact certification.
- [[SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0]] — ColombiaTours steel-thread migration spec for Hermes as primary runtime: native Hermes Kanban owns the runtime queue, one board scopes the account/website, profiles load explicit skills, tenant/provider context profiles feed `/goal` and North Star task scoring, profiles execute autonomous v0 actions through scoped MCP tools, and Supabase stores product/audit/snapshots/outcomes rather than runtime state.
- [[AUDIT_GROWTH_OS_PROVIDER_PROFILE_REGISTRY_MAP_2026-05]] — Issue #536 audit map for the provider-profile beta: registry inventory, execution surfaces, SEO/analytics/Clarity/paid-media PASS/WATCH/BLOCKED status, multi-tenant scoping contract and next implementation tasks.
- [[PLAN_GROWTH_OS_PROVIDER_RUNNER_BETA_ISSUE_538]] — Issue #538 implementation plan for the Provider Runner Beta: internal Node CLI/runner, GSC read-only daily minimum path first, GA4 second, freshness/budget/approval/circuit-breaker gates before provider calls, `growth_profile_runs` ledger reuse and no paid media mutations.
...
- [[growth-effectiveness-human-baseline-2026-05-11]] — Benchmark contract for proving Growth OS + Hermes effectiveness against a human/Codex baseline with executor-only production mutations.
...
- [[supabase-migration-reconciliation-2026-05-08]] — linked Flutter remote history audit for reconciling production before any repair/apply bundle.
...
| `[[SPEC_COLOMBIATOURS_LOCALE_TRUST_RECOVERY]]`        | `docs/specs/generated/colombiatours-locale-trust-recovery-SPEC.md`                 |
...
| `[[Kanban]]`                                          | `docs/specs/SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0.md` (concept alias)       |
| `[[tool-gateway]]`                                    | `docs/specs/SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0.md` (legacy concept alias) |
| `[[mcp-tool-safety]]`                                 | `docs/specs/SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0.md` (concept alias)       |
| `[[provider-context-profiles]]`                       | `docs/specs/SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0.md` (concept alias)       |
| `[[tenant-context]]`                                  | `docs/specs/SPEC_GROWTH_OS_HERMES_PRIMARY_RUNTIME_MVE_V0.md` (concept alias)       |
| `[[colombiatours-keyword-market-research-2026-05-11]]` | `docs/growth-campaigns/outputs/2026-05-11-colombiatours-keyword-market-research.md` |
| `[[colombiatours-global-keyword-market-research-v2-2026-05-11]]` | `docs/growth-campaigns/outputs/2026-05-11-colombiatours-global-keyword-market-research-v2.md` |
| `[[colombiatours-global-landings-2026-05-11]]` | `docs/growth-sessions/2026-05-11-1715-colombiatours-global-landings.md` |
| `[[colombiatours-global-transcreation-plan-2026-05-11]]` | `docs/growth-campaigns/outputs/2026-05-11-colombiatours-global-transcreation-plan.md` |
...
| `[[epic471-backlog-cleanup-2026-05-11]]` | `docs/growth-sessions/2026-05-11-epic471-backlog-cleanup.md` |
| `[[growth-effectiveness-human-baseline-2026-05-11]]` | `docs/growth-sessions/2026-05-11-growth-effectiveness-human-baseline.md` |
