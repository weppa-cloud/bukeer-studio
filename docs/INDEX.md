...
Last updated: 2026-05-18 (Phase 3 DB staging T1 plan gate validated: `PASS_WITH_WATCH` with 2 watch items — prerequisite function and deferrable constraint verification)
...
|| [[SPEC_GROWTH_CONTROL_PLANE_PHASE3_DB_STAGING_APPLY]]      | [file](./specs/SPEC_GROWTH_CONTROL_PLANE_PHASE3_DB_STAGING_APPLY.md)      | [[growth-os]] [[control-plane]] [[staging]] [[migrations]] [[backfill]] [[canary]] [[RLS]] [[rollback]] [[ColombiaTours]] — Phase 3 DB staging apply: validation SQL, staging target requirements, prod-block gate, RLS verification, and acceptance criteria |
|| [[SPEC_GROWTH_OS_PROVIDER_PROFILE_ARCHITECTURE_V2]]        | [file](./specs/SPEC_GROWTH_OS_PROVIDER_PROFILE_ARCHITECTURE_V2.md)        |
...
| [[growth-source-truth-colombiatours-ptbr]] | [file](./specs/SPEC_GROWTH_SOURCE_TRUTH_COLOMBIATOURS_PTBR.md) | Sprint spec: provider-runner/normalizer → `growth_signal_facts` → `growth_source_refs` → ContextPacket canary for ColombiaTours pt-BR/BR. |
...
- [T1 Governed Provider Runner Plan Gate](validation/t1-governed-provider-runner-plan-2026-05-19.md)
- [T2 Governed Provider Runner Implementation](validation/t2-governed-provider-runner-implementation-2026-05-19.md)
- [T3 Governed Provider Runner Validation](validation/t3-governed-provider-runner-validation-2026-05-19.md)
- [T4 Governed Provider Runner Ops Handoff](validation/t4-governed-provider-runner-ops-handoff-2026-05-19.md)
- [Learning Run — Governed Provider Runner ColombiaTours pt-BR v1](ai/learning-runs/2026-05-19-growth-governed-provider-runner-colombiatours-ptbr-v1.md)
