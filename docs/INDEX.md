...
Latest spec addition: 2026-05-16 - [[growth-profile-source-auditor-v1]] defines the first Growth OS governance tool: read-only profile/source auditor with 8-level verdict model, deterministic fixture mode, and static safety checks. [[growth-profile-source-auditor-v1-learning]] captures 8 curated learning candidates from the pipeline run.
...
| [[core-web-vitals-paid-landings]]       | [file](./ops/core-web-vitals-paid-landings.md)       | Daily CWV + funnel health runbook for paid landings, including direct-200 URL checks and incident response.                                            |
...
| [[growth-profile-source-auditor-v1]]     | [file](./ops/growth-profile-source-auditor-v1.md)     | Read-only Growth OS governance auditor for profile freshness, source refs, provider cache evidence and locale/market autonomous safety verdicts.        |
| [[growth-profile-source-auditor-v1-learning]] | [file](./ai/learning-runs/growth-profile-source-auditor-v1.md) | Learning run: 8 curated learning candidates for Growth OS governance tools, verdict precedence model, and agent definition locale alignment. |
...
| `[[core-web-vitals-paid-landings]]`                   | `docs/ops/core-web-vitals-paid-landings.md`                                        |
