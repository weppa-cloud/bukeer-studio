...
Latest spec addition: 2026-05-15 - [[SPEC_DEV_RUNTIME_STABILIZATION_V1]] defines the Hermes Kanban dev-runtime stabilization layer for Bukeer Studio: preflight, profile/tooling smoke, runtime defaults, auth fallbacks, worktree hygiene, session-pool QA, unknown-skill guard and learning materializer resume rules while preserving Neo as orchestrator and workers as implementers.
...
| [[SPEC_DEV_RUNTIME_STABILIZATION_V1]]                      | [file](./specs/generated/dev-runtime-stabilization-v1-SPEC.md)            | [[growth-os]] [[Hermes]] [[Kanban]] [[Neo]] [[dev-runtime]] [[session-pool]] [[skills]] [[learning-loop]] [[tech-validator]]                                    |
...
| [[development-kanban-pipeline]]          | [file](./ops/development-kanban-pipeline.md)          | Hermes Kanban worker preflight/runbook: `npm run kanban:preflight`, profile/skill guard, GitHub fallback, session-pool QA, learning resume safety and runtime defaults. |
...
- [[SPEC_DEV_RUNTIME_STABILIZATION_V1]] — dev-runtime stabilization for Bukeer Studio Kanban work: preflight gates, profile/tooling smoke, max runtime defaults, auth fallback, unknown-skill blocking, worktree hygiene, session-pool QA, and idempotent learning materializer resume rules; explicitly preserves Neo as orchestrator and workers as implementers. See [[development-kanban-pipeline]] for the executable worker runbook and `npm run kanban:preflight`.
...
| `[[SPEC_DEV_RUNTIME_STABILIZATION_V1]]`               | `docs/specs/generated/dev-runtime-stabilization-v1-SPEC.md`                        |
| `[[development-kanban-pipeline]]`                     | `docs/ops/development-kanban-pipeline.md`                                          |
