...
| Scope | Input | Covers |
|-------|-------|--------|
| `all` | — | `docs/**`, `.claude/rules/**`, `.claude/skills/**`, `CLAUDE.md` |
...
- [ ] Every `.md` in `.claude/skills/` is owned by a `SKILL.md` entry.
- [ ] Every `.claude/rules/*.md` referenced in `CLAUDE.md` or a skill.
...
- [ ] `docs/INDEX.md` exists and is reachable from `CLAUDE.md`.
